...
type AdminPostsTagsProps = {
  tags: string[];
};

export function AdminPostsTags({ tags }: AdminPostsTagsProps) {
  const [urlState, setUrlState] = useQueryStates(
    {
      tag: adminSearchParams.tag,
  ...
  function handleSelectionChange(keys: AriaSelection) {
    let newTags: string[];
    if (keys === "all") {
      newTags = tags;
    } else {
