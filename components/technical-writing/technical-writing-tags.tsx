              ...
              <TagList className="flex items-center gap-3">
                {tags.map((tag) => (
                  <Tag
                    ...
                    id={tag}
                    className={cn(
                      "cursor-pointer rounded-full border px-3 py-1.5 text-sm font-semibold outline-none transition-colors",
                      "focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2",
                      selectedTags.includes(tag)
                        ? "border-sky-700 bg-sky-700 text-white"
                        : "border-sky-200 bg-sky-100 text-sky-700 hover:border-sky-700 hover:bg-sky-700 hover:text-white",
                    )}
                  >
                    {tag}
                  </Tag>
